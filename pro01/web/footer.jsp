...
<footer class="ft" id="ft">
    ...
    <div class="ft_wrap2">
        ...
        <p class="copyright">
            <span>스마트런 1577-0902</span>
            <span>스마트런키즈 1577-0218</span>
            <span>스마트런인스트루 1577-6226</span>
            <span>스마트런메이커스 1577-1533</span>
        </p>
        <p class="locate">
            <select name="sel" id="sel" onchange="loc()">
                <option value="">FAMILY LINK</option>
                <option value="https://chunjaetext.co.kr/">스마트런키즈</option>
                <option value="http://www.milkt.co.kr/Main/Main_new">스마트런인스트루</option>
                <option value="http://www.prinpia.co.kr/">스마트런메이커스</option>
            </select>
        </p>
