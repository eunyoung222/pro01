    ...
    <div class="contents" id="contents">
        ...
        <section class="page" id="page1">
            <div class="page_wrap">
                ...
                <div class="inner">
                    <div class="img-area">
                        <img src="/images/architect.jpg" alt="교육원 설립">
                        <p>✅ 아이들이 더 가까운 곳에서 잘 배울 수 있도록 교육원을 설립합니다.</p>
                    </div>
                    <div class="img-area">
                        <img src="/images/meeting.jpg" alt="지자체와의 소통">
                        <p>✅ 지자체와의 소통을 통해 그 지역단체를 돕고 있습니다.</p>
                    </div>
                    <div class="img-area">
                        <img src="/images/toy.jpg" alt="장난감">
                        <p>✅ 아이들의 창의력을 위해 교구들을 기부합니다.</p>
                    </div>
                </div>
            </div>
        </section>
