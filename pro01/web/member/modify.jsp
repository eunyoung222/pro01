...
<%
    ...
    try {
        // DB에서 로그인한 회원의 정보를 검색하는 SQL 구문
        String sql = "select * from member where id=?";
        pstmt = conn.prepareStatement(sql);
        pstmt.setString(1, id);
        rs = pstmt.executeQuery();
        // 해당 회원의 정보를 DB에서 로딩하여 회원 객체의 필드의 값으로 저장
        if(rs.next()){
        ...
        <section class="page" id="page1">
            <div class="page_wrap">
                ...
                <table class="tb1">
                    ...
                    <tr>
                        <th>아이디</th>
                        <td><input type="text" value="<%=mem.getId() %>" name="id" id="id" readonly> </td>
                    </tr>
                    <tr>
                        <th>비밀번호</th>
                        <!-- re_pw에 입력한 값과 pw2의 값이 같으면 원래 pw 전달
